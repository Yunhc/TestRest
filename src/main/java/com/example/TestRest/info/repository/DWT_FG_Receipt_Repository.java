...
@Slf4j
@Repository
public class DWT_FG_Receipt_Repository {
	@Autowired
	private final JdbcTemplate jdbcTemplate;
	
	public DWT_FG_Receipt_Repository(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}
	
	//콤보 내용 조회
	public List<DWT_FG_Receipt_Res_Param> findList(DWT_FG_Receipt_Req_Param req_param){
		
		DWT_FG_Receipt_Sql.SELECT_QUERY(req_param );
