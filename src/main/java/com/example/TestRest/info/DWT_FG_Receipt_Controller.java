...
@Slf4j
@RestController
public class DWT_FG_Receipt_Controller {
	private DWT_FG_Receipt_Service dw_Service;
	
	@Autowired  // spring 4.3 버전 이상부터는 생략 가능
	public DWT_FG_Receipt_Controller(DWT_FG_Receipt_Service dw_Service) {
		this.dw_Service = dw_Service;
	}

	
	@CrossOrigin("*")
	@PostMapping(value="/dwt/fg_receipt/scan")
	@ResponseStatus(value = HttpStatus.OK)
	public Object dw_fg_receipt_save_List(@RequestBody DWT_FG_Receipt_Req_Param req_param) {
